...
<?php  $img_list = get_post_meta( get_the_ID(), 'brad_image_list', false );
  ...
  <!--post meta info -->
  <h3 class="blog-link"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('Permalink to %s', 'brad'), the_title_attribute('echo=0') ); ?>">
    <?php the_title(); ?>
    </a></h3>
  ...
  <div class="post-content">
    ...
    <?php while( have_rows('author') ): the_row(); 
      ...
      <div class="blog-author">
        ...
        <?php if( $phone ): ?>
        <p>ph: <a href="tel:61<?php echo $phone; ?>">61<?php echo $phone; ?></a></p>
        <?php endif; ?>
